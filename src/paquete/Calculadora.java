...
public class Calculadora extends javax.swing.JFrame {
    ...
    public Calculadora() {
        initComponents();
        this.setLocationRelativeTo(null); // Para cada vez que se ejecute el programa, aparezca en el centro de la pantalla.
    }
    ...
    private void initComponents() {
        ...
        casilla.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(51, 153, 255), 1, true));
    ...
    private void jButton17ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton17ActionPerformed
        ...
        switch(this.operador) {
            ...
            case "-":this.casilla.setText(sincero(this.primerNumero - this.segundoNumero)); break;
            case "*":this.casilla.setText(sincero(this.primerNumero * this.segundoNumero)); break;
            case "/":if(segundoNumero==0) {this.casilla.setText("No se divide en 0");}
